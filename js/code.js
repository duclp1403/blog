...
(function ($) {
  ...
  DHT.tabSliderToggle = function () {
    $(".c-tab__sliderToggle").on("click", ".c-tab__sliderButton", function (event) {
      event.preventDefault();
      var $this = $(this);
      $this.parents(".c-tab__sliderItem").find(".c-tab__sliderContent").slideToggle("fast", function () {
  ...
  $(document).on("click", ".js-get-maps-marker", function (event) {
    startLocal = $(this).find(".address p").text();
    calculateAndDisplayRoute(directionsService, directionsDisplay, startLocal, endLocal);
  });
  $(document).on("change", 'input[name="dia_chi"]', function (event) {
    endLocal = $(this).val();
    calculateAndDisplayRoute(directionsService, directionsDisplay, startLocal, endLocal);
  });
})(jQuery);
...
var map,
    ...
    directionsService,
    directionsDisplay,
    startLocal = "51 Phạm Viết Chánh, Phường Nguyễn Cư Trinh, Quận 1, Hồ Chí Minh, Việt Nam",
    endLocal = "51 Phạm Viết Chánh, Phường Nguyễn Cư Trinh, Quận 1, Hồ Chí Minh, Việt Nam",
    vnlat = 10.7660093,
    vnlng = 106.6807363;
...
function initMap() {
  ...
  map = new google.maps.Map(document.getElementById("mapCenter"), {
    zoom: 8,
    center: vn
  });
...
function calculateAndDisplayRoute(directionsService, directionsDisplay, startLocal, endLocal) {
